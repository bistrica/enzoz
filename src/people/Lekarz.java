...
public class Lekarz extends Pracownik {
	...
	public Lekarz(int id, String imie, String nazwisko, String pESEL,
			...
			String miejscowosc, String kod, String telefon, int PWZ) {
	...
	public Lekarz(Osoba person, int PWZ) {
		// person.ulica,person.nrDomu,person.nrMieszkania,person.miejscowosc,person.kod,person.telefon
		// zbêdne
		this(person.id, person.imie, person.nazwisko, person.PESEL,
				person.ulica, person.nrDomu, person.nrMieszkania,
				person.miejscowosc, person.kod, person.telefon, PWZ);
	}
